...
for row in soup('table', {'class': 'table-stats'})[0].tbody('tr'): # finds the table with class = 'table-stats' and extracts the information contained in the body(tbody) and tags(tr)
    tds = row('td')
